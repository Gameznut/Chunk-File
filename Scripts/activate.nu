...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Pablo Emmanuel\Documents\Pablo's Code\Python\Chunk File'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Pablo Emmanuel\Documents\Pablo's Code\Python\Chunk File\Scripts\deactivate.nu'
